			...
			<div class="row" >
				<div class="col"></div>
					<div class="col-8" style="margin:30px 30px;">
						...
						<form class="form-horizontal" action="consultarboletin.php" method="post" id="contacto" enctype="multipart/form-data" >
							<div class="form-row">
								<div class="form-group col-md-6">
								  <label for="">Seleccione Alumno:</label>
									<select class="custom-select" name="alumno">
										<?php
											$resultado=mysqli_query($conexion,"SELECT * FROM alumno where id_curso='$id_curso'");
											while($arreglo=mysqli_fetch_array($resultado)){
												echo"<option value=$arreglo[id_alumno]>$arreglo[apyn]</option>";
											}
										?>
									</select>
								</div>
